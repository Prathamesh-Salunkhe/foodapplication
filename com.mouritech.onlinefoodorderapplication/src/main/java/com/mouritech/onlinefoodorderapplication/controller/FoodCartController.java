...
public class FoodCartController {
	...
	public FoodCart showCartById(@PathVariable("cid") Long CartId) throws ResourceNotFoundException  {
	  ...
	  @GetMapping("ShowCartByCustomerId/{customerId}") 
	  public FoodCart showCartByCustomerId(@PathVariable("customerId") Long customerId) throws ResourceNotFoundException {
		  System.out.println("customerId"); 
		  return cartService.showCartByCustomerId(customerId); 
		  }
